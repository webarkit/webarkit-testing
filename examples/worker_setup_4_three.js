...
window.onload = async function () {
  ...
  grayCanvas.style.left = 0;
  grayCanvas.style.top = 0;
  grayCanvas.style.zIndex= 8;
  ...
  grayScaleVideo = new GrayScale.GrayScaleMedia(videoEl, oWidth, oHeight, grayCanvas);
  ...
  const context = grayScaleVideo.getContext();

  //const renderer = new THREE.WebGLRenderer({ context: context, alpha: true, antialias: true })
